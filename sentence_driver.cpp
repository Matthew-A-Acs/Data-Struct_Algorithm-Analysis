...
// Description: The program tests the functionallity of the sentence ADT. The 
// ADT is a linked list. It contains a default constructor, explicit-value constructor,
// copy constructor, destructor, and functions isEmpty, length, add_back, overloaded
// <<, =, and + operators, isEqual, and remove.
// -----------------------------------------------------------------------------

// Main driver to test the functionality of the program
int main()
{	
