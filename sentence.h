...
// Only defines SENTENCE_H if it has not already been defined
#ifndef SENTENCE_H
#define SENTENCE_H

// declaration of word class
class word
{
public:
	string term; // string data member
	word* next; // word pointer data member
};

// declaration of sentence class
class sentence
{
public:
	...
	void add_back(const string& s); // adds a word s to the back of the linked list
...
private:
	word* front, * back; // private data members
};
